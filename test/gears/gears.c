...
gear(GLfloat inner_radius, GLfloat outer_radius, GLfloat width,
  GLint teeth, GLfloat tooth_depth, GLfloat r, GLfloat g, GLfloat b)
{
  GLint i;
  GLfloat r0, r1, r2;
  GLfloat angle, da;
...
draw(void)
{
  ...
  glPushMatrix();
    ...
    glPushMatrix();
      ...
      gear(1.0, 4.0, 1.0, 20, 0.7, 0.8, 0.1, 0.0);
    glPopMatrix();

    glPushMatrix();
      glTranslatef(3.1, -2.0, 0.0);
      glRotatef(-2.0 * angle - 9.0, 0.0, 0.0, 1.0);
      gear(0.5, 2.0, 2.0, 10, 0.7, 0.0, 0.8, 0.2);
    glPopMatrix();

    glPushMatrix();
      glTranslatef(-3.1, 4.2, 0.0);
      glRotatef(-2.0 * angle - 25.0, 0.0, 0.0, 1.0);
      gear(1.3, 2.0, 0.5, 10, 0.7, 0.2, 0.2, 1.0);
    glPopMatrix();
...
init (void)
{
  ...
  glLoadIdentity();
  gluPerspective(20.f, 1.f, 1.f, 1000.f);
